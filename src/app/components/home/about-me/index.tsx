          ...
          <div className="container">
            ...
            <div className="pt-10 xl:pt-16 flex gap-10 items-center justify-between">
              ...
              <div className="w-full lg:max-w-2xl flex-1">
                <p>
                  I’m Ahmed Abidi, a creative designer who started learning design at a young age 
                  and has since developed strong skills in graphic design, video editing, and 
                  content management. I have worked on a wide range of projects, including freelance work 
                  and collaborations with companies, delivering high-quality visuals and engaging content 
                  that meet real business goals.
                </p>
                ...
                <div className="grid grid-cols-3 py-10 xl:py-16 gap-5 border-b border-mistGray">
                  {[
                    ...
                    { count: "17+", label: "Project Completed" },
                  ].map((item, i) => (
                    <div key={i}>
                      <h3>{item.count}</h3>
